...
class HomeFragment : Fragment() {
    ...
    val filmsDataBase = listOf(
        ...
        Film("Thor: Ragnarok", R.drawable.poster2, "Imprisoned on the planet Sakaar, Thor must race against time to return to Asgard and stop Ragnarök, the " +
                "destruction of his world, at the hands of the powerful and ruthless villain Hela.", 7.6f),
        Film("Lord of the Rings: The Fellowship of the Ring", R.drawable.lotr_1, "A meek Hobbit from the Shire and eight companions set out on a journey " +
                "to destroy the powerful One Ring and save Middle-earth from the Dark Lord Sauron.", 9.9f),
        Film("Harry Potter and the Prisoner of Azkaban", R.drawable.azkaban, "Harry Potter, Ron and Hermione return to Hogwarts School of Witchcraft and " +
                ...
                "wizard.", 8.1f),
        Film("Dark Knight", R.drawable.dark_knight, "When the menace known as the Joker wreaks havoc and chaos on the people of Gotham, Batman must " +
                "accept one of the greatest psychological and physical tests of his ability to fight injustice.", 8.9f)
    )
